...
class Proceso_Profesor{
    ...
    var $dir;      	var $tel;   	var $cel;      	var $correo;	var $especialidad;	var $estado;	var $conexion;
    
    function __construct($id, $nom, $ape, $doc, $fecha, $dir, $tel, $cel, $correo, $especialidad, $estado, $tipo, $con, $conexion){
		...
		$this->tipo=$tipo;	$this->con=$con;	$this->conexion = $conexion;
	}
    ...
    function guardar(){
        ...
        mysqli_query($this->conexion, "INSERT INTO profesor (nom, ape, doc, con, fecha, estado, dir, tel, cel, correo, especialidad, tipo) 
	...
	function actualizar(){
		...
		mysqli_query($this->conexion, "UPDATE profesor SET nom='$nom',
										ape='$ape',
										fecha='$fecha',
										estado='$estado',
										dir='$dir',
